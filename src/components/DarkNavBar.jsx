  ...
  return (
    <>
      <nav className="flex justify-between items-center p-8 w-full fixed top-0 left-0 z-50">
        <img  src="/DarkLogo.svg" alt="Logo" className="h-12 w-72 cursor-pointer" onClick={Homenavigate} />
        <ul className="flex justify-end w-full items-center gap-8 pr-12 text-[#212529] text-[18px] font-Inter">
        ...
        <li>
          <button onClick={ContactUsnavigate} className="bg-[#212529] text-white rounded-full py-2 px-6 cursor-pointer">
            Contact Us
          </button>
        </li>
      </ul>
