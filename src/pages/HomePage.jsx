  ...
  return (
    <>
     ...
     <div className="flex flex-col justify-end items-start h-screen bg-[url(/HomeBg.svg)] bg-cover bg-no-repeat">
      ...
      <div className="text-white gap-12 flex flex-col pb-12 px-4 md:px-0">
      ...
      <section>
        <HomePageSection />
        <div className="flex justify-end w-full p-6 md:p-20 gap-6 mb-14 ">
          <p className="text-[#212529] text-left py-10 mb-10 font-400 w-full md:w-[820px] text-[18px] leading-[25px]">
       ...
       <section>
        <div className="flex flex-col lg:flex-row gap-28 items-center bg-gray-200 p-0 sm:p-10 md:p-20 h-auto lg:h-[500px]">
        <img
      ...
      <section className="p-0 py-12 mb-12 sm:px-10 bg-gray-50">
        <InfoSection
