function PrivacyPolicy() {
  return (
    ...
    <section>
    <div className="max-w-full p-6 sm:p-8 lg:p-20 text-[#424649] bg-white">
    <h2 className="text-[32px] sm:text-[36px] lg:text-[40px] font-400 mb-4 text-[#212529]">1. Information we collect</h2>
    <p className="mb-6 max-w-[1200px] font-400 text-[14px] sm:text-[16px] md:text-xl">
    ...
    <p className="mb-6 w-full max-w-[1200px] font-400 text-[14px] sm:text-[16px] md:text-xl">
    ...
    <p className="w-full mb-10 max-w-[1200px] font-400 text-[14px] sm:text-[16px] md:text-xl">
