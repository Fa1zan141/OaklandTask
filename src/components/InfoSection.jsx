...
const InfoSection = ({ title, content, linkText, linkUrl }) => {
  return (
    <div className="p-6 sm:p-8 md:p-10 lg:w-1/2 w-full">
      <h2 className="text-[#212529] text-[40px] sm:text-4xl font-400">{title}</h2>
      <p className="w-full text-[#424649] sm:w-[790px] mt-6 text-base text-[18px] leading-[25px] sm:text-lg md:text-xl font-400">{content}</p>
      <a href={linkUrl} className="mt-4 inline-block text-[#212529] font-medium hover:underline">
        {linkText} →
      </a>
    </div>
  );
